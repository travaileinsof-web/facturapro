...
try {
    ...
    $queries = [
        ...
        "CREATE TABLE IF NOT EXISTS PasswordReset (
            id SERIAL PRIMARY KEY, email VARCHAR(255) NOT NULL, code VARCHAR(10) NOT NULL, expires_at TIMESTAMP NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        )",
        ...
        "CREATE TABLE IF NOT EXISTS LoginAttempt (
            ip VARCHAR(50) PRIMARY KEY, attempts INTEGER DEFAULT 1, last_attempt TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        )"
    ];
